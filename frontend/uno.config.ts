...
export default defineConfig({
  ...
  shortcuts: {
    'glass-card':
      'bg-bg-elevated backdrop-blur-12 border border-white/8 rounded-2xl shadow-glass',
    ...
    'text-gradient':
      'bg-gradient-to-br from-brand-purple to-brand-cyan bg-clip-text text-transparent',
  },
})
